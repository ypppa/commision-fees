...
class CommissionRulesParser implements ParserInterface
{
    ...
    public function parse(string $filePath): Generator
    {
        try {
            foreach ($this->reader->read($filePath) as $input) {
                $commissionFeRule = $this->denormalizer->denormalize($input, CommissionFeeRule::class);

                yield $commissionFeRule;
            }
